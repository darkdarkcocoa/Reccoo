# 코코아 레코더에 기여하기 / Contributing to Cocoa Recorder

코코아 레코더에 관심을 가져 주셔서 감사합니다! 🎀 버그 신고, 기능 제안, Pull Request 모두 환영합니다.
Thanks for your interest in Cocoa Recorder! Bug reports, feature ideas, and PRs are all welcome.
...
- **마스코트**: 코코아는 이미지 파일이 아니라 `Mascot.cs`에서 픽셀 단위로 그려집니다. 표정 추가는 `MascotMood` enum을 확장하는 방식으로 해 주세요.
