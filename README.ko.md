...
- **선택형 3초 카운트다운** — 정확한 타이밍이 필요할 때는 켜고, 빠르게 소리를 모을 때는 꺼서 즉시 녹음할 수 있습니다.
...
├── Mascot.cs                 # 코코 스프라이트 — 이미지가 아닌 픽셀 단위 드로잉
...
## 🎨 디자인 토큰
코코의 색상 팔레트입니다. UI를 수정할 때는 새 색상을 만들지 말고 이 팔레트 안에서 선택해 주세요.
